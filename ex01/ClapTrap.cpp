...
ClapTrap::ClapTrap(void) : name("default"), hitPoint(100), energyPoints(50), attackDamage(20)
{
...
ClapTrap::ClapTrap(std::string const _name) : name(_name), hitPoint(100), energyPoints(50), attackDamage(20)
{
